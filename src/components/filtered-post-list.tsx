...
export function FilteredPostList({ initialPosts, className }: FilteredPostListProps) {
  // 필터바 접힘/펼침 상태
  ...
  return (
    <div className={cn('space-y-6', className)} data-testid="filtered-post-list">
      {/* 필터 섹션 - 모든 상태에서 공통으로 표시 */}
      <FilterSection
