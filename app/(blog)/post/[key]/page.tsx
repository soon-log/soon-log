...
import { PostMetadata, getPostsJson } from '@/entities/post';
import { Giscus } from '@/shared/components';

import { PostLayout } from '../../_components/post-layout';

export async function generateStaticParams() {
  const posts = Object.values(await getPostsJson()).flat();
...
export async function generateMetadata({
  ...
  try {
    ...
    console.error('포스트 메타데이터 로드 실패:', error);
